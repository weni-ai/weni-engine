    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inteligence_organization', models.IntegerField(verbose_name='inteligence organization id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flow_organization', models.UUIDField(unique=True, verbose_name='flow identification UUID')),
                ('flow_organization_id', models.IntegerField(null=True, verbose_name='flow identification UUID')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project', to='common.Organization')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_type', models.CharField(choices=[('type_service_flows', 'Flows service'), ('type_service_inteligence', 'Inteligence Service'), ('type_service_chat', 'Chat Service')], default='type_service_chat', max_length=50, verbose_name='service type')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('last_updated', models.DateTimeField(auto_now_add=True, verbose_name='last updated')),
                ('default', models.BooleanField(default=False, verbose_name='standard service for all projects')),
                ('region', models.CharField(choices=[('region_ireland', 'Region Ireland'), ('region_virginia', 'Region Virginia'), ('region_sao_paulo', 'Region São Paulo')], default='region_sao_paulo', max_length=50, verbose_name='service region')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='service_status', to='common.Project')),
