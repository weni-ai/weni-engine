...
# source: weni/protos/connect/project.proto
...
ClassifierResponse = _reflection.GeneratedProtocolMessageType('ClassifierResponse', (_message.Message,), {
  ...
  '__module__' : 'weni.protos.connect.project_pb2'
