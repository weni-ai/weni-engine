...
env = environ.Env(
    ...
    PLAN_TRIAL_LIMIT=(int, 200),
    PLAN_BASIC_LIMIT=(int, 1000),
    PLAN_BASIC_PRICE=(int, 100),
    PLAN_PLUS_LIMIT=(int, 2000),
    PLAN_PLUS_PRICE=(int, 200),
    PLAN_PREMIUM_LIMIT=(int, 3000),
...
PLAN_BASIC_LIMIT = env.int("PLAN_BASIC_LIMIT")
PLAN_BASIC_PRICE = env.int("PLAN_BASIC_PRICE")

PLAN_PLUS_LIMIT = env.int("PLAN_PLUS_LIMIT")
PLAN_PLUS_PRICE = env.int("PLAN_PLUS_PRICE")

PLAN_PREMIUM_LIMIT = env.int("PLAN_PREMIUM_LIMIT")
PLAN_PREMIUM_PRICE = env.int("PLAN_PREMIUM_PRICE")
