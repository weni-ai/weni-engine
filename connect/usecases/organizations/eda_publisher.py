...
class OrganizationEDAPublisher:
    ...
    def publish_organization_deactivated(
        self,
        organization_uuid: UUID,
        deactivated_at: Optional[pendulum.DateTime] = None,
    ) -> None:
    ...
    def publish_organization_activated(
        self, organization_uuid: UUID, activated_at: Optional[pendulum.DateTime] = None
    ) -> None:
        if not self.rabbitmq_publisher:
            return
